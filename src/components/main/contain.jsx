...
const Contain = () => {
  return (
    <div className="xl:mt-[20.32rem] 2xl:mt-[24.15%] max-sm:mt-[8.1rem]">
      {/* brand */}
      <div className="flex flex-col-reverse">
        <div className="md:w-[50%] items-center  m-auto max-sm:text-center max-sm:my-20">
          <div
          ...
          max-sm:w-[327px] max-sm:h-[309px] ">
            ...
            <div>
              ...
              bg-[#fad400] mt-[-0.5rem] max-sm:m-auto"></div>
            </div>
          </div>
        </div>
        <div>
      ...
      <div className="flex flex-col">
        <div>
          ...
          />
          <img
            className="w-[100%] h-[312px] md:hiddden"
            src={juiceGlass1}
            alt=""
          />
        </div>
        <div className="md:w-[50%] items-center  m-auto max-sm:text-center max-sm:my-20">
          <div className="w-[445px] h-[285px] space-y-10 m-auto max-sm:w-[327px] max-sm:h-[309px] ">
            ...
            <div>
              ...
              <div
                className="opacity-[0.25] w-[137px] h-[10px] rounded-[28px] 
              bg-[#fe7766] mt-[-0.5rem] max-sm:m-auto"></div>
            </div>
          </div>
        </div>
      </div>{" "}
      <div className="flex flex-col">
        ...
        <div>
          <div>
            <img className="w-[100%] max-sm:hidden" src={cherry} alt="" />
            <img
              className="w-[100%] h-[600px] md:hiddden"
              src={cherry1}
              alt=""
            />
          </div>
